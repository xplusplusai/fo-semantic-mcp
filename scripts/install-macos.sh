#!/bin/bash
# FO Semantic MCP Server Installation Script for macOS/Linux
# Run as: bash install-macos.sh
...
echo "🚀 Installing FO Semantic MCP Server..."
...
BINARY_SOURCE="$SCRIPT_DIR/../bin/fo-semantic-mcp-macos"
...
cat > "$CONFIG_DIR/claude_desktop_config_example.json" << EOF
{
  "mcpServers": {
    "fo-semantic-mcp": {
...
echo "✅ Example configuration created: $CONFIG_DIR/claude_desktop_config_example.json"
...
echo "   4. Restart your MCP client (Claude Desktop, etc.)"
